...
public class SindicateEntity {
    ...
    public SindicateEntity(String nro_register_cct, Date date_start_cct, Date date_finish_cct,
    ...
    public SindicateEntity(int idSindicate, String nro_register_cct, Date date_start_cct, Date date_finish_cct) {
    ...
    public SindicateEntity(int idCB, int discount_basic, int value_basic, int limit_disc_basic,
    ...
    public SindicateEntity(int idVale, boolean falta_disc_va_vr, boolean falta_disc_vr,
    ...
    public SindicateEntity(int idBreakfest, boolean atest_disc, boolean atest_disc_prop, boolean falta_disc,
    ...
    public SindicateEntity(int idAutho, boolean normal_hour, boolean salary_advance, boolean bank_hours,
    ...
    public SindicateEntity(int idValues, int attendance, int base_salary, int health_insurance, int christmas_bonus,
    ...
    public SindicateEntity(int idPercents, int extra_hour_week, int extra_hour_saturday, int extra_hour_sunday_holidays,
            int sindicate_contr, int seconci, int salary_advance_percents, int incentive_qualify,
            int complem_retirement, int night_time) {
